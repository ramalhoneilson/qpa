"""
Tests for src/preprocessing/find_and_copy_notebooks.py
...
class TestArchiveNotebooks:
    ...
    def test_archive_notebooks_success(self):
        ...
        with patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS', ["/project1"]), \
             patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS_BASE_PATH', Path("/test")), \
             patch('src.preprocessing.find_and_copy_notebooks.NOTEBOOKS_DEST_ROOT', Path("/dest")), \
    ...
    def test_archive_notebooks_project_not_found(self):
        ...
        with patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS', ["/nonexistent"]), \
             patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS_BASE_PATH', Path("/test")), \
             patch('src.preprocessing.find_and_copy_notebooks.NOTEBOOKS_DEST_ROOT', Path("/dest")), \
    ...
    def test_archive_notebooks_multiple_projects(self):
        ...
        with patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS', ["/project1", "/project2"]), \
             patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS_BASE_PATH', Path("/test")), \
             patch('src.preprocessing.find_and_copy_notebooks.NOTEBOOKS_DEST_ROOT', Path("/dest")), \
             patch('pathlib.Path.is_dir', return_value=True), \
    ...
    def test_archive_notebooks_project_name_conversion(self):
        ...
        with patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS', ["/project/subdir"]), \
             patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS_BASE_PATH', Path("/test")), \
             patch('src.preprocessing.find_and_copy_notebooks.NOTEBOOKS_DEST_ROOT', Path("/dest")), \
             patch('pathlib.Path.is_dir', return_value=True), \
             patch('pathlib.Path.rglob', return_value=mock_notebooks), \
    ...
    def test_archive_notebooks_mixed_success_failure(self):
        ...
        with patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS', ["/project1", "/nonexistent"]), \
             patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS_BASE_PATH', Path("/test")), \
             patch('src.preprocessing.find_and_copy_notebooks.NOTEBOOKS_DEST_ROOT', Path("/dest")), \
    ...
    def test_archive_notebooks_empty_project_list(self):
        ...
        with patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS', []), \
             patch('src.preprocessing.find_and_copy_notebooks.TARGET_PROJECTS_BASE_PATH', Path("/test")), \
             patch('src.preprocessing.find_and_copy_notebooks.NOTEBOOKS_DEST_ROOT', Path("/dest")), \
             patch('builtins.print') as mock_print:
