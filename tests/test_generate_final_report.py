"""
Tests for src/workflows/generate_final_report.py
...
class TestMainFunction:
    ...
    def test_main_successful_execution(self):
        ...
        with patch('src.workflows.generate_final_report.INPUT_CSV_FILE') as mock_input_file, \
             ...
             patch('src.workflows.generate_final_report.load_all_patterns_from_files', return_value={"Pattern1"}), \
             patch('src.workflows.generate_final_report.ReportGenerator') as mock_generator_class, \
             patch('src.workflows.generate_final_report.config', self.mock_config), \
             patch('builtins.print') as mock_print:
    ...
    def test_main_data_processing(self):
        ...
        with patch('src.workflows.generate_final_report.INPUT_CSV_FILE') as mock_input_file, \
             ...
             patch('src.workflows.generate_final_report.load_all_patterns_from_files', return_value={"Pattern1", "Pattern2"}), \
             patch('src.workflows.generate_final_report.ReportGenerator') as mock_generator_class, \
             patch('src.workflows.generate_final_report.config', self.mock_config), \
...
class TestIntegration:
    ...
    def test_complete_workflow_integration(self):
        ...
        with patch('src.workflows.generate_final_report.INPUT_CSV_FILE') as mock_input_file, \
             ...
             patch('src.workflows.generate_final_report.load_all_patterns_from_files', return_value={"Pattern1", "Pattern2"}), \
             patch('src.workflows.generate_final_report.ReportGenerator') as mock_generator_class, \
             patch('src.workflows.generate_final_report.config', MagicMock()), \
             patch('builtins.print'):
