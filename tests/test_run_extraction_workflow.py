"""
Tests for src/workflows/run_extraction_workflow.py
...
from src.workflows.run_extraction_workflow import (
    main,
    run_pipeline,
)
...
class TestMainFunction:
    ...
    def test_successful_workflow_execution(self):
        ...
        with patch('src.workflows.run_extraction_workflow.extract_classiq.main', mock_classiq_main), \
             patch('src.workflows.run_extraction_workflow.extract_pennylane.main', mock_pennylane_main), \
             patch('src.workflows.run_extraction_workflow.extract_qiskit.main', mock_qiskit_main), \
             patch('src.workflows.run_extraction_workflow.run_pipeline') as mock_run_pipeline, \
             patch('logging.info') as mock_info:
    ...
    def test_workflow_logging_structure(self):
        ...
        with patch('src.workflows.run_extraction_workflow.extract_classiq.main', mock_classiq_main), \
             patch('src.workflows.run_extraction_workflow.extract_pennylane.main', mock_pennylane_main), \
             patch('src.workflows.run_extraction_workflow.extract_qiskit.main', mock_qiskit_main), \
             patch('src.workflows.run_extraction_workflow.run_pipeline'), \
             patch('logging.info') as mock_info:
...
class TestIntegration:
    ...
    def test_workflow_with_real_pipeline_functions(self):
        ...
        with patch('src.workflows.run_extraction_workflow.extract_classiq.main') as mock_classiq, \
             patch('src.workflows.run_extraction_workflow.extract_pennylane.main') as mock_pennylane, \
             patch('src.workflows.run_extraction_workflow.extract_qiskit.main') as mock_qiskit, \
             patch('src.workflows.run_extraction_workflow.run_pipeline') as mock_run_pipeline, \
             patch('logging.info'):
